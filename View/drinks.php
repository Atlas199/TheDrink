<div class="intro" data-parallax="scroll" data-z-index="1" data-image-src="IMG/whisky4.jpg"></div>

<div class="InfoTitulo">
    <h2 class="text-uppercase font-weight-bold">Catalogo de Whisky</h2>
</div>


<div class="col-md-10" style="padding-left: 15px;">
        <form action="?c=filterdrinnks" method="POST">
            ...
            <form action="?c=carrito" method="POST">
                ...
                <div class="form-row col-md-12" style="padding: 25px;">
                    <div class="col-md-2">
                        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <img src="<?php echo $prod->image; ?>" class="d-block w-100" alt="Drinks" height="155">
                                </div>
                                <div class="carousel-item">
                                <img src="IMG/drink-slogo.png" class="d-block w-100" alt="Drinks" height="155">
                                </div>
                            </div>
                    ...
                    <div class="col-md-2" style="padding-left:35px;">
                        ...
                        <label>Precio: $<?php echo $prod->price; ?></label>
